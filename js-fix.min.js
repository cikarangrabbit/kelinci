...
* Copyright (c) 2020 Cikarang Rabbit; */
...
var kelinci = ['cikarangrabbit.blogspot.com'];
var redirectURL = 'https://cikarangrabbit.blogspot.com/';
function cekLSN(value,arr){ var status = false; for(var i=0; i<arr.length; i++){ var name = arr[i]; if(name == value){ status = true; break; } } return status; } var hst = window.location.hostname; if(cekLSN(hst, kelinci) == false) { window.location.href = redirectURL; }